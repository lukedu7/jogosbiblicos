const levels = [
    'data/005.questoes_faceis.json',
    'data/006.questoes_medias.json',
    'data/007.questoes_dificeis.json'
];
...
function changeBackgroundColor() {
    ...
    console.log("images/Imagem de fundo definida:", body.style.backgroundImage);
}
